...
<head>
    ...
    <title>DailyBlog Documentation</title>
                ...
                <li class="tocify-item level-1" data-unique="user">
                    <a href="#user">User</a>
                                    ...
                                    <ul id="tocify-subheader-user" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="user-POSTapi-user-register">
                                <a href="#user-POSTapi-user-register">Register User</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<p>This API is not authenticated.</p>
        ...
        <h1 id="user">User</h1>
                                ...
                                <h2 id="user-POSTapi-user-register">Register User</h2>
